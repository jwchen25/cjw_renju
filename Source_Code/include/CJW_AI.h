...
class CJW_AI
{
    public:
        CJW_AI();
        virtual ~CJW_AI();
        void getPosition(char chesspadstate[15][15], int color);//根据当前形势，计算下步棋的位置
        int AI_Piece_x, AI_Piece_y;
    ...
    private:
        ...
        //棋局类型
        static const int WIN5 = 0;       //5连珠
        static const int ALIVE4 = 1;     //活4
        static const int DIE4 = 2;       //死4
        static const int LOWDIE4 = 3;    //死4的低级版本
        static const int ALIVE3 = 4;     //活3
        static const int TIAO3 = 5;      //跳3
        static const int DIE3 = 6;       //死3
        static const int ALIVE2 = 7;     //活2
        static const int LOWALIVE2 = 8;  //低级活2
        static const int DIE2 = 9;       //死2
        static const int NOTHREAT = 10;  //没有威胁
